...
| 报告安全漏洞 | [安全政策](SECURITY.md)；请勿创建公开 Issue |

氛寸由独立开发者单人维护，不承诺固定响应时间。处理顺序通常为安全问题、可复现的 Bug、Pull Request、功能建议。其他事情可以联系维护者 [@MrBaoboer](https://github.com/MrBaoboer) 主页上公开的邮箱。
